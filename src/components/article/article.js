...
function articleMaker(obj) {
  ...
  const article2nd = document.createElement('p')
  const article3rd = document.createElement('p')
  ...
  articleWrapper.appendChild(article1st)
  articleWrapper.appendChild(article2nd)
